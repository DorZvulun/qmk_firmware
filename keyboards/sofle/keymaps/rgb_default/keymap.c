...
// Define tap counter for tilde:
static uint16_t tilde_timer = 0;
static uint16_t tilde_count = 0;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /**/ _______, KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, /**/ _______, _______, /**/ KC_LBRC, KC_RBRC, MEH(KC_SLSH), LSAG(KC_QUOT), LCA(KC_SLSH), KC_RSFT,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
     ...
     * |------+------+------+------+------+------|  MUTE |    | PLAY  |------+------+------+------+------+------|
     * |Shift | Undo |  Cut | Copy | Paste w/o format|      |-------|    |-------|      | LStr |      | LEnd |      | Shift|
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | CTRL | ALT  |  CMD | LOWER| / Enter /       \Space \  |RAISE | APPS | ALT  | CTRL |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
    ...
    [_RAISE] = LAYOUT(
        ...
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /**/ _______, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LSA(LGUI(KC_V)), XXXXXXX, _______, _______, KC_LSTRT, XXXXXXX, KC_LEND, XXXXXXX, _______, KC_LSFT,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /*           */ _______, _______, _______, _______, _______, /**/ _______, _______, _______, _______, _______
        //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
        ),
     ...
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |QK_UNDERGLOW_TOGGLE|hue^ |sat ^ | bri ^|      |BL_MOD|-------.    ,-------|      |desk <|      |desk >|      |      |
     * |------+------+------+------+------+------|  MUTE |    | PLAY  |------+------+------+------+------+------|
    ...
    [_ADJUST] = LAYOUT(
        //,------------------------------------------------.                    ,---------------------------------------------------.
        EE_CLR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /*           */ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_QWERTY, KC_BRIU,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, BL_TOGG, /*           */ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BRID,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        QK_UNDERGLOW_TOGGLE, QK_UNDERGLOW_HUE_UP, QK_UNDERGLOW_SATURATION_UP, QK_UNDERGLOW_VALUE_UP, KC_NO, BL_STEP, /*           */ KC_NO, C(KC_LEFT), KC_NO, C(KC_RGHT), XXXXXXX, XXXXXXX,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        QK_UNDERGLOW_MODE_NEXT, QK_UNDERGLOW_HUE_DOWN, QK_UNDERGLOW_SATURATION_DOWN, QK_UNDERGLOW_VALUE_DOWN, XXXXXXX, BL_BRTG, /*           */ XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
        //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
        ),
    ...
    [_APPS] = LAYOUT(
        //,------------------------------------------------.                    ,---------------------------------------------------.
        /**/ KC_NO, LCAG(KC_4), KC_NO, KC_NO, KC_NO, KC_NO, /*                       */ LCAG(KC_6), LCAG(KC_7), KC_NO, KC_NO, KC_NO, KC_NO,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        /**/ KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LCAG(KC_I), /*                  */ LCAG(KC_Y), KC_NO, KC_NO, LCAG(KC_O), KC_NO, KC_NO,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        /**/ KC_NO, KC_NO, LCAG(KC_S), KC_NO, KC_NO, LCAG(KC_G), /*             */ KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LCAG(KC_QUOT),
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
bool process_record_user(uint16_t keycode, keyrecord_t* record) {
    switch (keycode) {
        ...
        case KC_GRV:  // `~` key
            if (record->event.pressed) {
                if (timer_elapsed(tilde_timer) < 500) {  // 500ms threshold
                    tilde_count++;
                } else {
                    tilde_count = 1; // Reset if time exceeded
                }
                tilde_timer = timer_read();

                if (tilde_count == 3) { // If pressed 3 times fast
                    tilde_count = 0;  // Reset count
                    tap_code16(LCTL(LGUI(KC_Q))); // Send Ctrl+Cmd+Q to lock Mac
                    return false; // Suppress the raw grave key when the lock combo fires
                }
            }
            return true; // Let the normal grave/tilde behavior through.
